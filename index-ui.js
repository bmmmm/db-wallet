(function () {
    ...
    function renderExistingUsers() {
        ...
        const userIds = Object.keys(wallets).sort((a, b) =>
            a.localeCompare(b),
        );
        ...
        for (const userId of userIds) {
            ...
            const entry =
                reg && typeof reg === "object" && reg[userId]
                    ? reg[userId]
                    : null;
            const lastUpdated =
                entry &&
    ...
    async function tryParseWalletIdFromHash(hash) {
        ...
        try {
            if (raw.startsWith("ac:")) {
                ...
                const decoded =
                    actionApi &&
                    typeof actionApi.decodeActionHash === "function"
    ...
    function importJsonFile(file) {
        ...
        reader.onload = async (ev) => {
            try {
                ...
                const chooseMode =
                    importPreview &&
                    typeof importPreview.chooseImportMode === "function"
